...
# FINAL CSS - Fixed all text visibility issues (especially st.info and low risk text)
st.markdown("""
<style>
    /* Main background */
    .stApp {
    ...
    /* FIX FOR st.info (Key factors text) - force dark text */
    .stAlert {
        color: #333333 !important;
    }
    ...
    /* Ensure success/error/warning text is visible */
...
# === Real-Time Fraud Predictor ===
    ...
    if submitted:
        ...
        # Key factors - now with dark text via CSS override
